...
$$
D_{in}^{k,j} = \frac{{\pi \Delta t_{i,j}^kR_0}}{{6{{\left( {{s_{i,j}}tg\left( {\frac{\alpha }{2}} \right) + {R_0}} \right)}}}}\mathop \smallint \limits_{{d_a}}^{{d_{b,{\rm{max}}}}} P\left( {{d_0},{s_{i,j}},{\rm{U}}} \right)G\left( {{d_0}} \right)E\left( {{d_b}} \right)d_0^3L\left( j,T \right) \xi_{dd}(d_o )d{d_b} \\
